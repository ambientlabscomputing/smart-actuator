...
/// Initialise tracing. The returned [`WorkerGuard`] **must** be kept alive for
/// the lifetime of the process — dropping it flushes and closes the log sink.
